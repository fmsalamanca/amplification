...
if True: #true to create a csv file with the experimental curve corrected
...
for i in range(reps):
    ...
    gcnet.append(gcnett)
    nufrr  = (gcdeff[i] - gcnett*(1-phieff))/(kb*T*phieff)
    nufr.append(nufrr)
